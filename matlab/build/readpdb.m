...
% octave/matlab replacement for MATLAB's pdbread, which is very slow
% this is a work in progress, updated on demand
%
...
if (qloud) ; toc ; fprintf('Processing ATOM records\n');end
