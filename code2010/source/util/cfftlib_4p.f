      SUBROUTINE FFT99_4P(A,WORK,TRIGS,IFAX,INC,JUMP,N,LOT,ISIGN)
C
...
C
   30 CONTINUE
      CALL FFT99A_4P(A,WORK,TRIGS,INC,JUMP,N,LOT)
      IGO=60
C
C     COMPLEX TRANSFORM
C     -----------------
C
   ...
   50 CONTINUE
      CALL VPASSM_4P(A(IA),A(IA+INC),WORK(1),WORK(2),TRIGS,
     *   INK,2,JUMP,NX,LOT,NH,IFAX(K+1),LA)
      IGO=60
      GO TO 70
   60 CONTINUE
      CALL VPASSM_4P(WORK(1),WORK(2),A(IA),A(IA+INC),TRIGS,
...
C
  130 CONTINUE
      CALL FFT99B_4P(WORK,A,TRIGS,INC,JUMP,N,LOT)
C
  140 CONTINUE
      RETURN
      END
      SUBROUTINE FFT99A_4P(A,WORK,TRIGS,INC,JUMP,N,LOT)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z)
...
C
   50 CONTINUE
      RETURN
      END
      SUBROUTINE FFT99B_4P(WORK,A,TRIGS,INC,JUMP,N,LOT)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z)
...
C
   50 CONTINUE
      RETURN
      END
      SUBROUTINE FFT991_4P(A,WORK,TRIGS,IFAX,INC,JUMP,N,LOT,ISIGN)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      DIMENSION A(*),WORK(*),TRIGS(*),IFAX(*)
C
...
C
  140 CONTINUE
      RETURN
      END
      SUBROUTINE FFTFAX_4P(N,IFAX,TRIGS)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z)
...
C     SORT FACTORS INTO ASCENDING ORDER
  ...
  110 CONTINUE
      RETURN
      END
      SUBROUTINE FFTRIG_4P(TRIGS,N,MODE)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z)
      DIMENSION TRIGS(*)
      PI=2.0*ASIN(1.0)
      IMODE=IABS(MODE)
   ...
   50 CONTINUE
      RETURN
      END
      SUBROUTINE VPASSM_4P(A,B,C,D,TRIGS,INC1,INC2,INC3,INC4,LOT,N,
     *                     IFAC,LA)
      IMPLICIT DOUBLE PRECISION (A-H, O-Z)
