...
consfile='../struc/'+name+'_sn-res.pdb'; # as in NAMD/ACEMD, this file must have identical atom ordering to that in the system topology
...
if (firstrun==0):
 ...
 if (firstrun>1): # run 1 restarts from 0eq, others, from <i>nvt
  flag='nvt';
 restart=1 ;
