...
constraintscaling=restraintK; # to scale harmonic restraints uniformly
conscol=1 ; # 1 beta ; 2 occupancy

bestFitRMSD=1 ;# harmonic restraint on the best-fit RMSD
bestFitK=-restraintK;
bestFitKperAtom=1 ;# force constant specified per atom, i.e. the RMSD force is scaled up by the number of atoms
