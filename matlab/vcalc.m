% Made "pretty" for Kwangho Nam by VO 12.2013
...
dfilter=5;      %to smoothen free energy profiles set dfilter > 1
...
lognames={...
        'voro105.log','voro106.log','voro107.log','voro108.log',...
...
fprintf([' Saving mean first massage times to file ',mfptfile,'\n']);
